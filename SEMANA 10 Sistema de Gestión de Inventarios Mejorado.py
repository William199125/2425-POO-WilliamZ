class Producto: # Este es un sistema de gestión de inventarios para la tienda mi mi mamá VIVERES ALICIA la cual va digitalizar todo el inventario de su tienda.
    # tomando en cuenta que con este sistema podra almacenar y recuperar los productos, tambien La interfaz de usuario ahora informa al usuario cuando un producto se añade, actualiza o elimina correctamente, y también muestra mensajes en caso de errores.
